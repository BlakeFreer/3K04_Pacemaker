 ...
 * C/C++ source code generated on : Fri Nov 25 12:05:17 2022
 *
...
#define Serial_example_IN_OFF          ((uint8_T)1U)
#define Serial_example_IN_RED_OFF      ((uint8_T)2U)
#define Serial_example_IN_RED_ON       ((uint8_T)3U)
...
void Serial_example_step(void)
{
  ...
  if (Serial_example_DW.is_active_c3_Serial_example == 0U) {
    ...
    Serial_example_B.red_en = 0U;
    Serial_example_B.green_en = 0U;
    Serial_example_B.blue_en = 0U;
  ...
  if (Serial_example_DW.is_active_c1_Serial_example == 0U) {
    ...
    switch (Serial_example_DW.is_c1_Serial_example) {
     case Serial_example_IN_OFF:
      rtb_red_out = false;
      switch (Serial_example_B.red_en) {
       case 1:
       ...
       case 0:
        Serial_example_DW.is_c1_Serial_example = Serial_example_IN_RED_OFF;
        break;
      }
      break;

     case Serial_example_IN_RED_OFF:
      rtb_red_out = false;
      switch (Serial_example_B.red_en) {
       case 1:
        Serial_example_DW.is_c1_Serial_example = Serial_example_IN_RED_ON;
  ...
  /* MATLABSystem: '<S4>/GREEN' incorporates:
   *  Constant: '<Root>/Constant'
   */
  MW_digitalIO_write(Serial_example_DW.obj_l.MW_DIGITALIO_HANDLE,
                     Serial_example_P.Constant_Value != 0.0);

  /* MATLABSystem: '<S4>/BLUE' incorporates:
   *  Constant: '<Root>/Constant'
   */
  MW_digitalIO_write(Serial_example_DW.obj_b.MW_DIGITALIO_HANDLE,
                     Serial_example_P.Constant_Value != 0.0);
}
