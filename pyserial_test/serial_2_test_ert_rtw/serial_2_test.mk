###########################################################################
## Makefile generated for component 'serial_2_test'. 
## 
## Makefile     : serial_2_test.mk
## Generated on : Fri Nov 25 23:07:42 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/serial_2_test.elf
...
COMPILER_COMMAND_FILE     = serial_2_test_comp.rsp
CMD_FILE                  = serial_2_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/serial_2_test.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=37 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=serial_2_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/serial_2_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/serial_2_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/serial_2_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/serial_2_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/serial_2_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/serial_2_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


serial_2_test.o : $(START_DIR)/serial_2_test_ert_rtw/serial_2_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


serial_2_test_data.o : $(START_DIR)/serial_2_test_ert_rtw/serial_2_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
